...
**76 database models · 62 enums · 27 API routers · 165 procedures ·
44 screens · 27 scheduled jobs · 23 audit scripts · 44 check suites.**
...
**Unit tests cover the pure logic, not the codebase.** 314 assertions in 18 files,
  ...
  stateful is still covered only by the 44 check suites and the
