...
The gate is green: `tsc` clean, 348 unit assertions, 50 check suites, 23
...
All 50 check suites are green. Read the reports before changing
...
## The shape of it
    ...
    prisma/schema.prisma      78 models
    ...
    src/server/jobs/          28 scheduled jobs, one run at a time by lease
