...
The gate is green: `tsc` clean, 334 unit assertions, 48 check suites, 23
...
All 48 check suites are green. Read the reports before changing
...
## The shape of it
    ...
    src/server/jobs/          27 scheduled jobs, one run at a time by lease
    src/app/                  45 screens, every one opened by browser:screens
