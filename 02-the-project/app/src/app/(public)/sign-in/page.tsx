    ...
    <main id="main" className="max-w-[46ch] mx-auto px-6 py-16">
      ...
      >
        ...
        <input
          ...
          className="w-full min-h-12 px-4 text-control text-ink bg-raised border border-rule rounded-lg focus-visible:outline-none focus-visible:shadow-[var(--ring)]"
        />

        {state === "failed" && (
          <p role="alert" className="text-ui text-danger mt-4 leading-snug">
