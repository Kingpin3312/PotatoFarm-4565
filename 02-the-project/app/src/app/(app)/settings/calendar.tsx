...
export function CalendarFeed() {
  ...
  return (
    <section className="mt-12 border-t border-rule pt-7">
      ...
      <p className="max-w-[56ch] text-ink-2 text-[15px]">
      ...
      {data?.url && (
        <div className="mt-5">
          <label
            htmlFor="cal-url"
            className="font-mono text-[10px] uppercase tracking-[0.12em] text-ink-3 block mb-2"
          >
            Your private link
          </label>
          <div className="flex gap-2 flex-wrap items-center">
            <input
              ...
              className="flex-1 min-w-[260px] font-mono text-[12px] bg-sunk border border-rule rounded-md px-3 min-h-11 text-ink-2"
            />
          ...
          <p className="mt-3 text-[13px] leading-snug text-ink-2 max-w-[58ch]">
          ...
          <div className="mt-5">
            {!confirming ? (
              ...
              <div className="border border-rule rounded-lg p-4 bg-sunk max-w-[52ch]">
                <p className="text-[15px] text-ink font-semibold">Replace it?</p>
