    ...
    <>
      ...
      >
        ...
        {!running && data.pausedAt && (
          <div className="border-t border-rule bg-raised px-6 py-4 font-mono text-[11px] tracking-[0.06em] text-ink-2">
      ...
      >
        <div className="p-6">
          ...
          <label htmlFor="why" className="block font-mono text-[10px] uppercase tracking-[0.12em] text-ink-3 mt-5 mb-1.5">
