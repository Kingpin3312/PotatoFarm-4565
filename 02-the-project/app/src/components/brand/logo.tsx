...
export function Mark({ size = 26, className = "" }: { size?: number; className?: string }) {
  return (
    <svg viewBox="0 0 64 64" aria-hidden="true" focusable="false"
      ...
      <defs><linearGradient id="shl" x1="22%" y1="10%" x2="74%" y2="90%"><stop offset="0" stopColor="#E86A2C"/><stop offset="0.5" stopColor="#E86A2C"/><stop offset="1" stopColor="#E86A2C"/></linearGradient><filter id="bll"><feGaussianBlur stdDeviation="7"/></filter><filter id="dpl" x="-35%" y="-35%" width="180%" height="180%"><feDropShadow dx="0" dy="2" stdDeviation="2.2" floodColor="#E86A2C" floodOpacity="0.18"/></filter><clipPath id="cpl"><path d="M32.6,3.0 C39.6,2.8 45.0,7.6 47.8,14.6 C50.2,20.6 51.2,27.2 51.6,33.6 C52.0,40.6 51.0,47.6 46.6,52.8 C42.2,58.0 34.8,61.4 27.6,60.8 C20.4,60.2 14.2,55.4 11.8,48.6 C9.4,41.8 10.2,34.2 11.6,27.0 C13.0,19.4 15.4,11.4 21.2,6.4 C24.2,3.9 28.6,3.2 32.6,3.0 Z"/></clipPath></defs><path d="M32.6,3.0 C39.6,2.8 45.0,7.6 47.8,14.6 C50.2,20.6 51.2,27.2 51.6,33.6 C52.0,40.6 51.0,47.6 46.6,52.8 C42.2,58.0 34.8,61.4 27.6,60.8 C20.4,60.2 14.2,55.4 11.8,48.6 C9.4,41.8 10.2,34.2 11.6,27.0 C13.0,19.4 15.4,11.4 21.2,6.4 C24.2,3.9 28.6,3.2 32.6,3.0 Z" fill="url(#shl)" stroke="#E86A2C" strokeWidth="1.7" strokeLinejoin="round" filter="url(#dpl)"/><g clipPath="url(#cpl)"><ellipse cx="24" cy="17" rx="17" ry="18" fill="#FFFFFF" opacity="0.20" filter="url(#bll)"/></g><ellipse cx="26.4" cy="29.6" rx="2.6" ry="4.1" fill="#3B2416"/><ellipse cx="38.4" cy="29.2" rx="2.6" ry="4.1" fill="#3B2416"/><path d="M46.0,33.4 C46.6,42.0 42.8,49.8 35.2,53.4" fill="none" stroke="#3B2416" strokeWidth="1.6" strokeLinecap="round" opacity="0.55"/><path d="M23.8,45.6 C26.0,48.2 29.6,48.6 32.2,46.6" fill="none" stroke="#3B2416" strokeWidth="1.8" strokeLinecap="round" opacity="0.85"/><path d="M23.4,15.4 C25.2,13.9 27.6,13.8 29.4,15.0" fill="none" stroke="#3B2416" strokeWidth="1.6" strokeLinecap="round" opacity="0.7"/><ellipse cx="42.4" cy="17.4" rx="1.0" ry="1.3" fill="#3B2416" opacity="0.5"/><ellipse cx="43.4" cy="44.0" rx="1.1" ry="1.4" fill="#3B2416" opacity="0.45"/>
    </svg>
  );
}
