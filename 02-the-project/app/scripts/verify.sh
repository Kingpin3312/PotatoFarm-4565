...
NEEDS_DB="tenancy intake intelligence autonomy buyers search qualification quiet migration vault load"
...
printf '\n%sChecks%s\n' "$bold" "$off"
for name in tenancy intake intelligence voice deals autonomy buyers search qualification quiet migration vault sigv4 storage load; do
